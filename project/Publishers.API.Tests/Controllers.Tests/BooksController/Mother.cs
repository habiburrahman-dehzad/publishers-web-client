...
namespace Publishers.API.Tests.Controllers.Tests.BooksController
{
    ...
    {
        /// <summary>
        /// Creates an in memory list of books similar to the documents of the MongoDB database for testing purposes.
        /// </summary>
        /// <returns></returns>
        public static List<Book> CreateListOfBookModels()
        {
